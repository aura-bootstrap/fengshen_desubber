# Compile the Inno installer for admin_client from release\admin_client\windows\ (assemble the release folder first).
$ErrorActionPreference = 'Stop'
$root = Split-Path -Parent $MyInvocation.MyCommand.Path   # installer\admin_client
